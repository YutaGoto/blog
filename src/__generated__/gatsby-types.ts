...
type staticHomeyougotoprojectsblogsrccomponentsseoTsx2137539840QueryVariables = Exact<{ [key: string]: never; }>;


type staticHomeyougotoprojectsblogsrccomponentsseoTsx2137539840Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
...
type BlogPostBySlugQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'siteUrl'>> }>, readonly markdownRemark: Maybe<(
    ...
    & { readonly fields: Maybe<Pick<Fields, 'slug'>>, readonly frontmatter: Maybe<Pick<Frontmatter, 'title' | 'date' | 'description'>> }
