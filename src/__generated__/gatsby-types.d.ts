...
type SiteSiteMetadataFilterInput = {
  ...
  readonly social: InputMaybe<SocialFilterListInput>;
  readonly title: InputMaybe<StringQueryOperatorInput>;
};
...
type SocialFilterListInput = {
  readonly elemMatch: InputMaybe<SocialFilterInput>;
};
...
type BioQuery = { readonly site: { readonly siteMetadata: { readonly author: { readonly name: string | null, readonly summary: string | null } | null, readonly social: ReadonlyArray<{ readonly name: string | null, readonly url: string | null } | null> | null } | null } | null };
...
type TagListQuery = { readonly allMarkdownRemark: { readonly group: ReadonlyArray<{ readonly fieldValue: string | null, readonly totalCount: number }> } };

type TagPageQueryVariables = Exact<{ [key: string]: never; }>;


type TagPageQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null } | null } | null, readonly allMarkdownRemark: { readonly group: ReadonlyArray<{ readonly fieldValue: string | null, readonly totalCount: number }> } };
